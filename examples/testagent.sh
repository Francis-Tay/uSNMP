#!/bin/sh
# ...using the Net-SNMP binaries.
# Start the usnmpd agent with the command "usnmpd P.38644.30" in another shell.
# Make sure that UDP port 161 is not used by another SNMP agent.
